...
if __name__ == "__main__":
    ...
    # Use the exact same approach as in the request_otp function
    mobile_number = "1234567890"  # Placeholder phone number for testing
    
    # Use the same approach that worked in the request_otp function
    url = "https://api.zeptonow.com/api/v1/user/customer/send-otp-sms/"
    payload = "{\"mobileNumber\":\"" + mobile_number + "\"}"
    headers = {
        'accept': 'application/json',
